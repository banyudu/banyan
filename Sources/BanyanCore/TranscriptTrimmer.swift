...
public enum TranscriptTrimmer {
    ...
    public struct Outcome: Equatable {
        ...
        public var trimmedCount: Int
        public var bytesSaved: Int

        public init(content: String, trimmedCount: Int, bytesSaved: Int) {
    ...
    public static func placeholder(originalBytes: Int) -> String {
